...
public class Monster
{
	...
	protected Room	fRoom = null;
	protected Room  fLastRoom = null;
//	protected Room  fLastHunt = null;
	protected Room	fTargetRoom = null;
	protected int	fEndurance;
	protected boolean fStationary = false;

	protected boolean fHunting = false;
	protected boolean fMoving = true;
...
//		fLastHunt = null;
	...
	public void setStationary(boolean stay)
	{
		fStationary = stay;
	}
...
//			return fRoom;
		...
		if (room != null)
		{
			...
			if (GameEngine.instance.hasPlayer(fRoom))
				if (GameEngine.instance.rand.range(0, 1) == 0)
					return fRoom;
		}
...
// 			this.makeNoise(Player.kFightNoise);
	...
	protected boolean move(Room room)
	{
...
//			if (GameEngine.rand.range(1, 25) == 1)
			...
			{
				if (GameEngine.instance.fDisplayDebugInfo)
