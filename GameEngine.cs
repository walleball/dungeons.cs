...
namespace Dungeons
{
    ...
    public static bool fDisplayDebugInfo = false;

    static int[] POOL_BONUS_GOLD = { 1, 0, 1, 0, 2 };
    static int[] POOL_BONUS_ARROWS = { 0, 1, 0, 2, 0 };

	private static int kWoundBonus = 1;
//	private static int kMagicSeed = 19;	// updated 20070506
//	private static int kMagicSeed = 20;	// updated 20070508
//	private static int kMagicSeed = 21;	// updated 20070605
//	private static int kMagicSeed = 22;	// updated 20070629
//	private static int kMagicSeed = 23;	// updated 20070726
//	private static int kMagicSeed = 24;	// updated 20070831
//	private static int kMagicSeed = 25;	// updated 20070920
//	private static int kMagicSeed = 26;	// updated 20071005
//	private static int kMagicSeed = 27;	// updated 20071027
// 	private static int kMagicSeed = 28;	// updated 20071122
//	public static int kMagicSeed = 29;	// updated 20071214
//	public static int kMagicSeed = 30;	// updated 20080115
//	public static int kMagicSeed = 31;	// updated 20080311
//	public static int kMagicSeed = 32;	// updated 20080313
//	public static int kMagicSeed = 33;	// updated 20080318
//  public static int kMagicSeed = 34;	// updated 20080409
// 	public static int kMagicSeed = 35;	// updated 20080529
//	public static int kMagicSeed = 36;	// updated 20080617
//	public static int kMagicSeed = 37;	// updated 20080712
//	public static int kMagicSeed = 38;	// updated 20080728
//	public static int kMagicSeed = 39;	// updated 20080801
//	public static int kMagicSeed = 40;	// updated 20080805
//	public static int kMagicSeed = 41;	// updated 20080810
//	public static int kMagicSeed = 42;	// updated 20080816
//	public static int kMagicSeed = 43;	// updated 20080909
//	public static int kMagicSeed = 44;	// updated 20080930
//  public static int kMagicSeed = 45;	// updated 20081019
//  public static int kMagicSeed = 46;	// updated 20081026
//  public static int kMagicSeed = 47;	// updated 20081126
//	public static int kMagicSeed = 48;	// updated 20081215
// 	public static int kMagicSeed = 49;	// updated 20090210
//	public static int kMagicSeed = 50;	// updated 20090304
// 	public static int kMagicSeed = 51;	// updated 20090323
//  public static int kMagicSeed = 52;	// updated 20090421
//	public static int kMagicSeed = 53;	// updated 20090511
//	public static int kMagicSeed = 54;	// updated 20090526
//	public static int kMagicSeed = 55;	// updated 20090603
// 	public static int kMagicSeed = 56;	// updated 20090607
	public static int kMagicSeed = 57;    // updated 20090609

	private static int kLightningMultiplier = 1;
	private static int kArrowMultiplier = 2;
	private static int kFireballMultiplier = 2;
	private static int kFightMultiplier = 3;

	public static int kMaxNumRooms = 40;
	private static int kMaxNumMonsters = 60;		// 50

	private static int kNumSwordDungeons = 4;
	private static int kNumShieldDungeons = 3;
	private static int kNumSandalDungeons = 2;
	...
	public GameEngine(Device device, DungeonRecord dungeon, PlayerRecord[] records)
	{
		...
		GameEngine.rand = new RandomNumber(kMagicSeed);
		...
		GameEngine.rand = new RandomNumber(seed);
		Sequence.seed(seed);
...
//			str = str.substring(str.lastIndexOf(' ')+1);
		...
		{
			num = rand.range(1, num_lairs);
			Room lair = fMaze.getLair(num);
...
//		bool hasRing = false;
		...
		GameEngine.rand = null;
		GameEngine.rand = new RandomNumber();

		monster_score += lair_score;
		while (monster_score > 0 && num_lairs > 0)
		{
			num = rand.range(1, num_lairs);
			Utility.Trace("Spawning from lair #" + num);

			Room room = fMaze.getLair(num);
...
//		Room[] path = fMaze.findRoute(fromRoom, toRoom, null, Maze.USE_LOCKED_DOORS);
	...
	public Monster getMonster(int no)
	{
...
// 		if (currentPlayer.fRing == 0 && currentRoom.fRing != 0)
	...
	public void doCommandDoor(bool key)
	{
		Player currentPlayer = this.getCurrentPlayer();
        Room currentRoom = currentPlayer.fRoom;
		...
		else
		{
            ...
            if (currentRoom.fWeb)
			{
				if (count >= fEncounter)
				{
					...
					if (GameEngine.rand.range(0, 5) <= currentPlayer.getStrength())
					{
...
// 						fMonsterAttacks++;
                        ...
                        if ((monster is Dragon || monster is Balrog) && currentPlayer.fDragonSwords > fSwordAttacks && !currentPlayer.isParalyzed())
						{
							// whack the monster!
							int low = 1;
							int high = 5;
						...
						{
							bool parried = !currentPlayer.isParalyzed();
							...
							else
							{
								...
								if (monster is Dragon || monster is Balrog)
								{
									if (damage > 0)
									{
                                        if (currentPlayer.fHitPoints > damage)
	...
	public bool hasPlayer(Room room)
	{
		if (this.countPlayers(room) == 0)
			return false;
		return true;
	}
	public bool hasAdjacentMonster(Room room)
	{
		for (int iMonster = 1 ; iMonster <= this.fNumMonsters ; iMonster++)
		{
			Monster monster = this.getMonster(iMonster);
	...
	public bool hasMonster(Room room)
	{
		for (int iMonster = 1 ; iMonster <= this.fNumMonsters ; iMonster++)
		{
			Monster monster = this.getMonster(iMonster);
