...
namespace Dungeons
{
    ...
    private bool fSpawn = false;

	public static int kMaxPassages = 20;
	public static int kExitNumber = 0;
	public static int kMuckCount = 30;
	public static int kScentCount = 10; // 8;	// 6

    public static int kLairProduction = 10;

	public static int kPortcullisNone = 0;
	public static int kPortcullisOpen = 1;
	public static int kPortcullisClosed = 2;

	private static int kMaxMonsterBuffer = 200;
...
// 		for (int i = 0 ; i < 3 ; ++i)
    ...
    public bool hasUnblockedPassage()
    {
...
// 		}
	...
	public bool hasTakeableContent()
	{
        if (this.fWater > 0)
			return true;
...
//		System.Array.Sort(fPassages, 0, fNumPassages);
	...
	*/
	public bool hasPassage(Room room)
	{
		for (int iPassage = 0 ; iPassage < fNumPassages ; iPassage++)
		{
	...
	public bool isBlockedByPortcullis(Room room)
	{
		for (int iPassage = 0 ; iPassage < fNumPassages ; iPassage++)
		{
			if (fPassages[iPassage] == room)
	...
	public bool isBlockedByPortcullis(int no)
	{
		if (fPortcullis[no-1] == kPortcullisClosed)
			return true;
		return false;
	}
	public bool isPassable(int no)
	{
		if (this.isBlockedByPortcullis(no))
			return false;
		return true;
	}
	public bool isPassable(Room room)
	{
		for (int iPassage = 0 ; iPassage < fNumPassages ; iPassage++)
		{
			if (fPassages[iPassage] == room)
...
/*
	public bool hasScentTo(Room room)
	{
		int count = 0;
		for (int i = 0 ; i < 3 ; i++)
		{
