...
// 				TRACE_BUFFER[TRACE_INDEX] = new String;
		...
		System.Console.WriteLine("trace: " + str);
	}
		...
		static public void Assert(bool cond, String str)
		{
			if (!cond)
			{
				TRACE = true;
		...
		static public String numToStr(int num)
		{
			...
			if (num == 90)
				return "Ninety";
			if (num > 90)
				return "Ninety" + numToStr(num - 90).ToLower();
			if (num == 80)
				return "Eighty";
			if (num > 80)
				return "Eighty" + numToStr(num - 80).ToLower();
			if (num == 70)
				return "Seventy";
			if (num > 70)
				return "Seventy" + numToStr(num - 70).ToLower();
			if (num == 60)
				return "Sixty";
			if (num > 60)
				return "Sixty" + numToStr(num - 60).ToLower();
			if (num == 50)
				return "Fifty";
			if (num > 50)
				return "Fifty" + numToStr(num - 50).ToLower();
			if (num == 40)
				return "Forty";
			if (num > 40)
				return "Forty" + numToStr(num - 40).ToLower();
			if (num == 30)
				return "Thirty";
			if (num > 30)
				return "Thirty" + numToStr(num - 30).ToLower();
			if (num == 20)
				return "Twenty";
			if (num > 20)
				return "Twenty" + numToStr(num - 20).ToLower();
			return Convert.ToString(num);
		}

		static public String numToStr(int num, String singular, String plural)
		{
			String str = singular;
			if (num == 0)
				str = "No " + plural;
		...
		static public String numToStrLower(int num, String singular, String plural)
		{
			String str = singular;
			if (num == 0)
				str = "no " + plural;
			else if (num > 1)
				str = Utility.numToStr(num).ToLower() + " " + plural;
			return str;
		}
